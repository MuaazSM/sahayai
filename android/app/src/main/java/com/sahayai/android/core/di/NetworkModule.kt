...
object NetworkModule {
    ...
    // Single mock/real switch — no mock code anywhere else
    @Provides
    @Singleton
    fun provideApiService(retrofit: Retrofit): SahayAIApiService {
        return if (BuildConfig.USE_MOCK_DATA) {
            MockApiService()
        } else {
            retrofit.create(SahayAIApiService::class.java)
        }
    }
}
